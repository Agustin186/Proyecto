...
def detalle_arqueo(request, id_caja):
    ...
    egresos = arqueo.egresos.all()

    # Acceder a ventas y compras asociadas al arqueo
    ventas = arqueo.ventas.all()  
    compras = arqueo.compras.all()  # Asegúrate de incluir las compras
    ...
    # Calcular el total de egresos incluyendo las compras
    total_egresos = subtotal_egresos + subtotal_compras
